...
def write_bigwig(tsv_file, sizes_file, chrom_list, outfile_name, stat='signal'):
    ...
    if stat.lower() not in ['signal', 'ptrace', 'rtrace', 'residuals_ivw']:
        raise ValueError('stat must be either "signal", "ptrace", "rtrace", "residuals_ivw".')
