...
OBSERVATION_DEFAULT_DEPENDENCE_NUM_BLOCKS: Final[int] = 2048
...
OBSERVATION_DEFAULT_DEPENDENCE_POSTERIOR_QUANTILE: Final[float] = 0.9
...
FIT_DEFAULT_BACKGROUND_SMOOTHNESS: Final[float] = 64.0
FIT_DEFAULT_BACKGROUND_LENGTH_SCALE_MULTIPLIER: Final[float] = 10.0
