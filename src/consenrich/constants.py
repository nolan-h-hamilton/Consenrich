...
PROCESS_DEFAULT_Q_TREND_RATIO_PRIOR_STRENGTH: Final[float] = 100.0
PROCESS_DEFAULT_Q_LEVEL_PRIOR_STRENGTH: Final[float] = 1.0
PROCESS_DEFAULT_Q_TREND_LEVEL_RATIO_PRIOR: Final[float] = 0.001
PROCESS_DEFAULT_WARMUP_ECM_ITERS: Final[int] = 50
PROCESS_DEFAULT_WARMUP_OUTER_PASSES: Final[int] = 5
PROCESS_DEFAULT_WARMUP_Q_NUISANCE_PASSES: Final[int] = 3
...
DEFAULT_CONFIGURATION_VALUES: Final[ConfigurationProfileMap] = {
    GENERIC_DEFAULT_CONFIGURATION: {
        ...
        "processParams.qLevelPriorStrength": (PROCESS_DEFAULT_Q_LEVEL_PRIOR_STRENGTH),
        "processParams.qTrendLevelRatioPrior": PROCESS_DEFAULT_Q_TREND_LEVEL_RATIO_PRIOR,
