...
PROCESS_NOISE_DEFAULT_REGULARIZATION_RATIO: Final[float] = 1.0e-4
PROCESS_NOISE_DEFAULT_WARMUP_ECM_ITERS: Final[int] = 25
PROCESS_NOISE_DEFAULT_WARMUP_OUTER_PASSES: Final[int] = 5
...
PROCESS_DEFAULT_PRECISION_MULTIPLIER_MIN: Final[float] = 0.5
PROCESS_DEFAULT_PRECISION_MULTIPLIER_MAX: Final[float] = 2.0
...
OBSERVATION_DEFAULT_TREND_NUM_BASIS: Final[int] = 100
...
OBSERVATION_DEFAULT_PRECISION_MULTIPLIER_MIN: Final[float] = 0.5
OBSERVATION_DEFAULT_PRECISION_MULTIPLIER_MAX: Final[float] = 2.0
...
FIT_DEFAULT_USE_NONNEGATIVE_BACKGROUND: Final[bool] = False
...
FIT_DEFAULT_MIN_OUTER_ITERS: Final[int] = 2
FIT_DEFAULT_BACKGROUND_SHIFT_RTOL: Final[float] = 1.0e-4
FIT_DEFAULT_OUTER_NLL_RTOL: Final[float] = 1.0e-4
FIT_DEFAULT_BACKGROUND_SMOOTHNESS: Final[float] = 1.0
FIT_DEFAULT_BACKGROUND_LENGTH_SCALE_MULTIPLIER: Final[float] = 8.0
...
MATCHING_DEFAULT_TAU0: Final[float] = 1.0
...
MATCHING_DEFAULT_NESTED_ROCCO_BUDGET_SCALE: Final[float] = 0.5
...
UNCERTAINTY_CALIBRATION_DEFAULT_CALIBRATION_ECM_ITERS: Final[int] = 3
...
ROCCO_BUDGET_MAX: Final[float] = 0.10
...
MASSIVE_SUBPEAK_MIN_PEAKS: Final[int] = 50
...
MASSIVE_SUBPEAK_MIN_CHILD_BP: Final[int] = 1000
