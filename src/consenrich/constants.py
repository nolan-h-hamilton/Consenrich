...
PROCESS_DEFAULT_Q_SEED_PRIOR_LEVEL: Final[float] = PROCESS_DEFAULT_MIN_Q
...
PROCESS_DEFAULT_TUNC_MIN_SCALE: Final[float] = 0.25
PROCESS_DEFAULT_TUNC_MAX_SCALE: Final[float] = 4.00
...
PROCESS_DEFAULT_WARMUP_OUTER_PASSES: Final[int] = 5
...
OBSERVATION_DEFAULT_USE_COUNT_NOISE_FLOOR: Final[bool] = False
...
FIT_DEFAULT_BACKGROUND_SHIFT_RTOL: Final[float] = 0.001
FIT_DEFAULT_OUTER_NLL_RTOL: Final[float] = 1.0e-6
FIT_DEFAULT_BACKGROUND_SMOOTHNESS: Final[float] = 25.0
FIT_DEFAULT_BACKGROUND_LENGTH_SCALE_MULTIPLIER: Final[float] = 32.0
...
UNCERTAINTY_CALIBRATION_DEFAULT_CALIBRATION_OUTER_ITERS: Final[int] = 3
...
ROCCO_NULL_QUANTILE: Final[float] = 0.75
