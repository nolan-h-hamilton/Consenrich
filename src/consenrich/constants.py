...
UNCERTAINTY_CALIBRATION_REFIT_PROCESS_Q_CALIB_ITERS = 1
UNCERTAINTY_CALIBRATION_REFIT_PROCESS_Q_CALIB_OUTER_ITERS = 1
PROCESS_Q_DEFAULT_TREND_TARGET_RATIO = 0.05
