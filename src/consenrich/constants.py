...
PROCESS_DEFAULT_Q_TREND_RATIO_PRIOR_STRENGTH: Final[float] = 1.0
PROCESS_DEFAULT_Q_LEVEL_PRIOR_STRENGTH: Final[float] = 10.0
PROCESS_DEFAULT_Q_TREND_LEVEL_RATIO_PRIOR: Final[float] = 0.1
