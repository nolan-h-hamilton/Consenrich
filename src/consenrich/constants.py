...
OBSERVATION_DEFAULT_DEPENDENCE_WORKING_QUANTILE: Final[float] = 0.90
OBSERVATION_DEFAULT_DEPENDENCE_BOOTSTRAP_DRAWS: Final[int] = 500
OBSERVATION_DEFAULT_DEPENDENCE_MIN_WINDOW_COUNT: Final[int] = 10
OBSERVATION_DEFAULT_DEPENDENCE_MIN_AUTOSOME_COUNT: Final[int] = 1
...
FIT_DEFAULT_BACKGROUND_LENGTH_SCALE_MULTIPLIER: Final[float] = 18.0
...
OUTPUT_DEFAULT_STATE_SHRINKAGE_SPIKE_ODDS_MULTIPLIER: Final[float] = 2.5
