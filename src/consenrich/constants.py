...
PROCESS_DEFAULT_WARMUP_OUTER_PASSES: Final[int] = 1
...
OBSERVATION_DEFAULT_MUNC_SEED_WEIGHT_PASSES: Final[int] = 2
...
OBSERVATION_DEFAULT_MUNC_EB_PRIOR_SUPPORT_MIN_Q: Final[float] = 0.005
OBSERVATION_DEFAULT_MUNC_EB_PRIOR_SUPPORT_MAX_Q: Final[float] = 0.995
...
OBSERVATION_DEFAULT_MUNC_EB_PRIOR_WARMUP_OUTER_PASSES: Final[int] = 2
...
UNCERTAINTY_CALIBRATION_DEFAULT_DELETE_BLOCK_FACTOR_SEGMENT_COUNT: Final[int] = 5
UNCERTAINTY_CALIBRATION_DEFAULT_DELETE_BLOCK_FACTOR_BOOTSTRAP_REPLICATES: Final[int] = 8
