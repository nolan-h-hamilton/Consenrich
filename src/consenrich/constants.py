...
PROCESS_DEFAULT_Q_PRIOR_LEVEL: Final[float] = 1.0e-2
...
PROCESS_DEFAULT_NOISE_CALIBRATION: Final[str] = PROCESS_NOISE_CALIBRATION_TUNC
PROCESS_DEFAULT_TUNC_LOCAL_WINDOW_MULTIPLIER: Final[float] = 1.0
PROCESS_DEFAULT_TUNC_DEPENDENCE_MULTIPLIER: Final[float] = 1.0
PROCESS_DEFAULT_TUNC_MIN_SCALE: Final[float] = 0.01
PROCESS_DEFAULT_TUNC_MAX_SCALE: Final[float] = 100.0
PROCESS_DEFAULT_TUNC_MIN_WINDOW_WEIGHT: Final[float] = 2.0
PROCESS_DEFAULT_TUNC_PRIOR_RIDGE: Final[float] = 1.0e-2
PROCESS_DEFAULT_TUNC_LEVEL_BUFFER_Z: Final[float] = 1.64
PROCESS_DEFAULT_TUNC_USE_RELIABILITY_WEIGHTED_WINDOWS: Final[bool] = False
PROCESS_DEFAULT_TUNC_TREND_SEED_RATIO: Final[float] = 0.01
TUNC_COVARIATES_MODE_TRANSITION: Final[str] = "transition"
TUNC_SUPPORTED_COVARIATE_MODES: Final[StrTuple] = (TUNC_COVARIATES_MODE_TRANSITION,)
TUNC_COVARIATE_FEATURES: Final[StrTuple] = ()
PROCESS_DEFAULT_TUNC_COVARIATES_ENABLED: Final[bool] = False
PROCESS_DEFAULT_TUNC_COVARIATES_MODE: Final[str] = TUNC_COVARIATES_MODE_TRANSITION
PROCESS_DEFAULT_TUNC_COVARIATE_FEATURES: Final[StrTuple] = TUNC_COVARIATE_FEATURES
...
MUNC_EB_PRIOR_G_UNCERTAINTY_MODE_PROXY: Final[str] = "proxy"
...
OBSERVATION_DEFAULT_TREND_MAX_EDF: Final[float] = 8.0
...
DEFAULT_CONFIGURATION_VALUES: Final[ConfigurationProfileMap] = {
    GENERIC_DEFAULT_CONFIGURATION: {
        ...
        "processParams.tuncMinScale": PROCESS_DEFAULT_TUNC_MIN_SCALE,
        "processParams.tuncMaxScale": PROCESS_DEFAULT_TUNC_MAX_SCALE,
        "processParams.tuncMinWindowWeight": (PROCESS_DEFAULT_TUNC_MIN_WINDOW_WEIGHT),
        "processParams.tuncPriorRidge": PROCESS_DEFAULT_TUNC_PRIOR_RIDGE,
        "processParams.tuncLevelBufferZ": PROCESS_DEFAULT_TUNC_LEVEL_BUFFER_Z,
        ...
        "processParams.tuncProcessCovariates.enabled": (
            PROCESS_DEFAULT_TUNC_COVARIATES_ENABLED
        ),
        "processParams.tuncProcessCovariates.mode": (
            PROCESS_DEFAULT_TUNC_COVARIATES_MODE
        ),
        "processParams.tuncProcessCovariates.features": (
            PROCESS_DEFAULT_TUNC_COVARIATE_FEATURES
        ),
