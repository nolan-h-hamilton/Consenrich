...
OBSERVATION_DEPENDENCE_MAX_CONTEXT_CEILING_BP: Final[int] = 50_000
OBSERVATION_DEFAULT_DEPENDENCE_MAX_CONTEXT_SIZE_BP: Final[int] = (
    OBSERVATION_DEPENDENCE_MAX_CONTEXT_CEILING_BP
)
OBSERVATION_DEFAULT_DEPENDENCE_NUM_BLOCKS: Final[int] = 1000
OBSERVATION_DEFAULT_DEPENDENCE_BLOCK_MEDIAN_BP: Final[float] = 25_000
...
OBSERVATION_DEFAULT_DEPENDENCE_PRIOR_MEDIAN_SPAN: Final[float] = 250.0
...
OBSERVATION_DEFAULT_DEPENDENCE_ACF_MIN_EVIDENCE_NATS: Final[float] = 2.0
...
OUTPUT_DEFAULT_STATE_SHRINKAGE_NULL_PSEUDO_COUNT: Final[float | None] = None
OUTPUT_DEFAULT_STATE_SHRINKAGE_NULL_PSEUDO_COUNT_FRACTION: Final[float] = 0.1
OUTPUT_DEFAULT_STATE_SHRINKAGE_NULL_PSEUDO_COUNT_MIN: Final[float] = 1.0e-6
OUTPUT_DEFAULT_STATE_SHRINKAGE_NULL_PSEUDO_COUNT_MAX: Final[float] = 1.0e6
...
UNCERTAINTY_CALIBRATION_DEFAULT_HOLDOUT_FRACTION_MIN: Final[float] = 0.1
UNCERTAINTY_CALIBRATION_DEFAULT_HOLDOUT_FRACTION_MAX: Final[float] = 0.2
...
UNCERTAINTY_CALIBRATION_DEFAULT_TARGET_CALIBRATION_DELTA: Final[float] = 0.1
...
UNCERTAINTY_CALIBRATION_DEFAULT_DELETE_BLOCK_FACTOR_SEGMENT_COUNT: Final[int] = 32
...
MATCHING_ROCCO_PEAK_MODE_STANDARD: Final[str] = "standard"
MATCHING_ROCCO_PEAK_MODE_BROAD: Final[str] = "broad"
MATCHING_ROCCO_PEAK_MODES: Final[StrTuple] = (
    MATCHING_ROCCO_PEAK_MODE_STANDARD,
    MATCHING_ROCCO_PEAK_MODE_BROAD,
)
MATCHING_DEFAULT_ROCCO_PEAK_MODE: Final[str] = MATCHING_ROCCO_PEAK_MODE_STANDARD
MATCHING_DEFAULT_ROCCO_SUBPEAK_LENGTH_SCALE_BP: Final[int | None] = None
...
DEFAULT_CONFIGURATION_VALUES: Final[ConfigurationProfileMap] = {
    GENERIC_DEFAULT_CONFIGURATION: {
        ...
        "matchingParams.roccoPeakMode": MATCHING_DEFAULT_ROCCO_PEAK_MODE,
