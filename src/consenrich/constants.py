...
PROCESS_DEFAULT_PRECISION_MULTIPLIER_MIN: Final[float] = 0.90
PROCESS_DEFAULT_PRECISION_MULTIPLIER_MAX: Final[float] = 1.10
...
PROCESS_DEFAULT_TUNC_LEVEL_BUFFER_Z: Final[float] = 1.0
