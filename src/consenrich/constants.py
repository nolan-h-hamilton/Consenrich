...
PROCESS_DEFAULT_TUNC_MIN_SCALE: Final[float] = 0.10
PROCESS_DEFAULT_TUNC_MAX_SCALE: Final[float] = 10.00
...
FIT_DEFAULT_BACKGROUND_NEGATIVE_PENALTY_MULTIPLIER: Final[float] = 0.25
