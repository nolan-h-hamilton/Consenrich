...
PROCESS_DEFAULT_TUNC_LOCAL_WINDOW_MULTIPLIER: Final[float] = 2.0
PROCESS_DEFAULT_TUNC_DEPENDENCE_MULTIPLIER: Final[float] = 2.0
...
MUNC_AR1_VARIANCE_FUNCTIONAL_MARGINAL: Final[str] = "marginal"
MUNC_AR1_VARIANCE_FUNCTIONAL_INNOVATION: Final[str] = "innovation"
MUNC_AR1_SUPPORTED_VARIANCE_FUNCTIONALS: Final[StrTuple] = (
    MUNC_AR1_VARIANCE_FUNCTIONAL_MARGINAL,
    MUNC_AR1_VARIANCE_FUNCTIONAL_INNOVATION,
)
MUNC_AR1_OBSERVATION_VARIANCE_FUNCTIONAL: Final[str] = (
    MUNC_AR1_VARIANCE_FUNCTIONAL_MARGINAL
)
MUNC_AR1_MAX_BETA_DEFAULT: Final[float] = 0.99
MUNC_AR1_PAIRS_REG_LAMBDA_DEFAULT: Final[float] = 1.0
MUNC_SUPPORTED_VARIANCE_MODELS: Final[StrTuple] = (MUNC_VARIANCE_MODEL_AR1,)
OBSERVATION_DEFAULT_MUNC_VARIANCE_MODEL: Final[str] = MUNC_VARIANCE_MODEL_AR1
OBSERVATION_DEFAULT_MUNC_AR1_VARIANCE_FUNCTIONAL: Final[str] = (
    MUNC_AR1_OBSERVATION_VARIANCE_FUNCTIONAL
)
...
UNCERTAINTY_CALIBRATION_DEFAULT_CALIBRATION_ECM_ITERS: Final[int] = 25
UNCERTAINTY_CALIBRATION_DEFAULT_CALIBRATION_OUTER_ITERS: Final[int] = 4
