...
PROCESS_Q_CALIBRATION_DEFAULT_OUTER_ITERS = 3
UNCERTAINTY_CALIBRATION_REFIT_PROCESS_Q_WARMUP_ECM_ITERS = 3
UNCERTAINTY_CALIBRATION_REFIT_PROCESS_Q_WARMUP_OUTER_ITERS = 2
PROCESS_Q_DEFAULT_TREND_TARGET_RATIO = 0.01
PROCESS_Q_TREND_FLOOR_RATIO = 1.0e-10
PROCESS_Q_NUMERICAL_FLOOR = 1.0e-10
