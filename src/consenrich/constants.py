...
OBSERVATION_DEFAULT_MUNC_TREND_BLOCK_DEPENDENCE_MULTIPLIER: Final[float] = 1.0  ###
OBSERVATION_DEFAULT_MUNC_LOCAL_WINDOW_DEPENDENCE_MULTIPLIER: Final[float] = 1.0  ###
...
FIT_DEFAULT_ROBUST_T_NU: Final[float] = 10.0  ### increase --> gaussian
...
FIT_DEFAULT_BACKGROUND_SHIFT_RTOL: Final[float] = 0.01  ###
...
ROCCO_BUDGET_MAX: Final[float] = 0.2  ###
