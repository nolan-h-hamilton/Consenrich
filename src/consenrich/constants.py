...
FIT_DEFAULT_BACKGROUND_LENGTH_SCALE_MULTIPLIER: Final[float] = 25.0
...
DEFAULT_CONFIGURATION_VALUES: Final[ConfigurationProfileMap] = {
    GENERIC_DEFAULT_CONFIGURATION: {
        ...
        "processParams.tuncPriorDf": PROCESS_DEFAULT_TUNC_PRIOR_DF,
