...
COUNTING_DEFAULT_SUBTRACT_GLOBAL_MEDIAN: Final[bool] = True
...
PROCESS_DEFAULT_PRECISION_MULTIPLIER_MIN: Final[float] = (
    1.0e-3  # if < 0, triggers smallest convexity-preserving bound
)
PROCESS_DEFAULT_PRECISION_MULTIPLIER_MAX: Final[float] = 1.0e3
...
PROCESS_DEFAULT_PUNC_PRIOR_DF_MOMENTS_MIN_WINDOWS: Final[int] = 8
...
PROCESS_DEFAULT_PUNC_DEADBAND_PRIOR_WEIGHT: Final[float] = 0.5
...
PUNC_SUPPORTED_COVARIATE_MODES: Final[StrTuple] = (
    PUNC_COVARIATES_MODE_TRANSITION,  # TODO: no intended extension, might delete
)
...
OBSERVATION_DEFAULT_MUNC_DEPENDENCE_MIN_CONTEXT_SIZE_BP: Final[int] = 1_000
...
FIT_DEFAULT_FIXED_BACKGROUND_RTOL: Final[float] = 1.0e-8
...
FIT_DEFAULT_BACKGROUND_SHIFT_RTOL: Final[float] = 8.0e-3
FIT_DEFAULT_OUTER_NLL_RTOL: Final[float] = 8.0e-5
...
OUTPUT_DEFAULT_STATE_SHRINKAGE_PRIOR_NULL: Final[float | None] = None
...
UNCERTAINTY_CALIBRATION_DEFAULT_DELETE_BLOCK_FACTOR_SEGMENT_COUNT: Final[int] = 10
...
MATCHING_DEFAULT_MIN_PEAK_SCORE: Final[float | None] = 0.05
...
MASSIVE_SUBPEAK_MIN_BP: Final[int] = 8000
...
DEFAULT_CONFIGURATION_VALUES: Final[ConfigurationProfileMap] = {
    GENERIC_DEFAULT_CONFIGURATION: {
        ...
        "outputParams.stateShrinkagePriorNull": OUTPUT_DEFAULT_STATE_SHRINKAGE_PRIOR_NULL,
