...
PROCESS_DEFAULT_PUNC_MIN_SCALE: Final[float] = 0.01
PROCESS_DEFAULT_PUNC_MAX_SCALE: Final[float] = 100.0
...
PROCESS_DEFAULT_PUNC_TREND_SEED_RATIO: Final[float] = 0.9
...
MASSIVE_SUBPEAK_MIN_BP: Final[int] = 10_000
