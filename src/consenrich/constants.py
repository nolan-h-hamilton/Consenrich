...
COUNTING_DEFAULT_CENTER_MB_METHOD: Final[str] = COUNTING_CENTER_MB_METHOD_SAVGOL
...
PROCESS_DEFAULT_NOISE_CALIBRATION: Final[str] = PROCESS_NOISE_CALIBRATION_FIXED_DIAGONAL
PROCESS_DEFAULT_WARMUP_ECM_ITERS: Final[int] = 50
PROCESS_DEFAULT_WARMUP_OUTER_PASSES: Final[int] = 2
...
OBSERVATION_MIN_DEPENDENCE_WORKING_SPAN_BP: Final[int] = 1500
...
OUTPUT_DEFAULT_DELETE_BEDGRAPHS_AFTER_BIGWIG: Final[bool] = True
...
OUTPUT_DEFAULT_STATE_SHRINKAGE_ENABLED: Final[bool] = True
...
OUTPUT_DEFAULT_STATE_SHRINKAGE_SPIKE_ODDS_MULTIPLIER: Final[float] = 2.0
...
UNCERTAINTY_CALIBRATION_DELETE_BLOCK_REPLICATE_DEPENDENCE_RHO_AUTO: Final[str] = "auto"
UNCERTAINTY_CALIBRATION_DEFAULT_DELETE_BLOCK_REPLICATE_DEPENDENCE_RHO: Final[
    str | float
...
DEFAULT_CONFIGURATION_VALUES: Final[ConfigurationProfileMap] = {
    GENERIC_DEFAULT_CONFIGURATION: {
        ...
        "observationParams.smoothToFraglen": OBSERVATION_DEFAULT_SMOOTH_TO_FRAGLEN,
        ...
        "outputParams.stateShrinkageEnabled": OUTPUT_DEFAULT_STATE_SHRINKAGE_ENABLED,
        ...
        "outputParams.stateShrinkageSpikeOddsMultiplier": (
            OUTPUT_DEFAULT_STATE_SHRINKAGE_SPIKE_ODDS_MULTIPLIER
        ),
